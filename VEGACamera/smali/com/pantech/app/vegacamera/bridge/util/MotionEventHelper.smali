.class public final Lcom/pantech/app/vegacamera/bridge/util/MotionEventHelper;
...
.method public static transformEvent(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Landroid/view/MotionEvent;
    ...
    .prologue
    .line 33
    sget-boolean v0, Lcom/pantech/app/vegacamera/bridge/common/ApiHelper;->HAS_MOTION_EVENT_TRANSFORM:Z

    if-eqz v0, :cond_0

    .line 34
    invoke-static {p0, p1}, Lcom/pantech/app/vegacamera/bridge/util/MotionEventHelper;->transformEventNew(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Landroid/view/MotionEvent;
    ...
    :cond_0
    invoke-static {p0, p1}, Lcom/pantech/app/vegacamera/bridge/util/MotionEventHelper;->transformEventOld(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Landroid/view/MotionEvent;
...
.method private static transformEventOld(Landroid/view/MotionEvent;Landroid/graphics/Matrix;)Landroid/view/MotionEvent;
    ...
    invoke-static/range {p0 .. p0}, Lcom/pantech/app/vegacamera/bridge/util/MotionEventHelper;->getPointerIds(Landroid/view/MotionEvent;)[I

    move-result-object v8

    .line 54
    .local v8, pointerIds:[I
    invoke-static/range {p0 .. p0}, Lcom/pantech/app/vegacamera/bridge/util/MotionEventHelper;->getPointerCoords(Landroid/view/MotionEvent;)[Landroid/view/MotionEvent$PointerCoords;
    ...
    .line 66
    .end local v18           #n:Landroid/view/MotionEvent;
    :cond_0
    ...
    invoke-static {v0, v1}, Lcom/pantech/app/vegacamera/bridge/util/MotionEventHelper;->transformAngle(Landroid/graphics/Matrix;F)F
